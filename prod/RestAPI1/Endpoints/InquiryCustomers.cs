...
public static class InquiryCustomers
{
    public static IEndpointRouteBuilder MapInquiryCustomers(this IEndpointRouteBuilder app)
    {
        app.MapGet("InquiryCustomers", async (BomDb db) =>
        {
            try
            {
