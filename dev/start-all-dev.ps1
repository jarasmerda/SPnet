# ============================================================
# DEV prostředí – spustí CRM, RestAPI1, RestAPI2
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "
    ...
    Write-Host '[DEV] RestAPI2 spuštěn (port 6106)' -ForegroundColor Yellow
    dotnet run
" -WindowStyle Normal
...
Write-Host "  RestAPI2: http://localhost:6106" -ForegroundColor Cyan
Write-Host "=====================================================" -ForegroundColor Cyan
