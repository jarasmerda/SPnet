# ============================================================
# PROD prostředí – spustí CRM, RestAPI1
...
Write-Host "  CRM:      http://SRV-TERMINAL:5127" -ForegroundColor Yellow
Write-Host "  RestAPI1: http://SRV-TERMINAL:5005" -ForegroundColor Yellow
Write-Host "=====================================================" -ForegroundColor Yellow
